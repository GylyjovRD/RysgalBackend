...
class OrderCreateDocsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['status', 'total_price', 'payment_type', 'region', 'address', 'is_active', 'items']
...
class OrderItemsOutSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrderItems
        fields = ['id', 'product_price', 'product', 'qty']

class OrderDetailSerializer(serializers.ModelSerializer):
    items = OrderItemsOutSerializer(many=True, source='order_products')
    class Meta:
        model = Order
        fields = ['id', 'status', 'total_price', 'payment_type', 'region', 'address', 'is_active', 'created_at', 'updated_at', 'items']